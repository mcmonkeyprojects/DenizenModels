                ...
                - choose <[before_frame.interpolation]>:
                    ...
                    - case bezier:
                        - if <[channel]> == rotation:
                            ...
                            - define q2 <[after_frame.right_time].as[quaternion]||<[before_frame.right_value].as[quaternion]>>
                        ...
                        - else:
                            ...
                            - define p2 <[after_frame.right_time].as[location]||<[before_frame.right_value].as[location]>>
